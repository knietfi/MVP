import{dS as x,er as te,di as c,dk as ne,d4 as g,d5 as j,d8 as m,d9 as b,da as d,d7 as l,dI as k,du as z,dJ as u,d6 as se,dq as f,dc as D,dG as L,en as le,dY as V,dm as U,dM as R,dy as F,df as ce,dj as A,dU as T,ek as q,dH as de,de as ie,es as ue,et as he}from"./index-pZ75OhRE.js";import{P as _}from"./index-CRw204XG.js";import{S as pe}from"./SwapController-DevFN5C3.js";const oe={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await te.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&ne.disconnect(),x.close()}},me=g`
  :host {
    display: block;
